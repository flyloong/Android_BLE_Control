...
public class DeviceScanActivity extends ListActivity {
    ...
    UUID u1       = UUID.fromString(SampleGattAttributes.VALUE_SERVICE);
    final UUID[] myUUID = { u1,UUID_ADC,UUID_PWM,UUID_GPIO,UUID_TIO };
  //  final UUID[] myUUID = { u1 };
    ...
    protected void onResume() {
        ...
        scanLeDevice(true);		///when on ,start scan for 10 sec
    }
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            //viewHolder.deviceTime.setText("2013-10-04,20:22:22");
